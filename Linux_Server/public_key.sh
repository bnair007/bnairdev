...
#!/bin/bash
whiptail --title "Account Summary" --textbox /tmp/useradd.log  20 80
#!/bin/bash
{     for ((i = 0 ; i <= 100 ; i+=30)); do         sleep 1;         echo $i;     done; } | whiptail --gauge "    Please wait while user is getting Installed.." 6 60 0
else
